...
INSERT INTO `events` VALUES (2,'Sample Event 1','An example event','2018-05-09','2018-05-09','600 Medinah Rd, Roselle, IL',1,'2018-01-15'),(3,'Sample Event 2','Another example event','2018-05-08','2018-05-08','500 W Bryn Mawr Ave, Roselle, IL',1,'2018-02-10'),(4,'Sample Event 3','Another example event','2018-02-16','2018-02-16','123 Example St, Bloomingdale, IL',1,'2018-02-14'),(5,'Sample Event 4','Another example event','2018-03-31','2018-03-31','321 Another Rd, Medinah, IL',1,'2018-03-19');
...
DROP TABLE IF EXISTS `passrecovertokens`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `passrecovertokens`
--

LOCK TABLES `passrecovertokens` WRITE;
/*!40000 ALTER TABLE `passrecovertokens` DISABLE KEYS */;
INSERT INTO `passrecovertokens` VALUES ('4L6SJHiWKGYxQ84V',123456,'2018-04-29'),('CfmtbNuiupiNlicK',123456,'2018-04-29'),('f5LT2RKVVPKAOrpU',123456,'2018-04-29'),('mq3sHdx3j5DfDBRv',123456,'2018-04-29');
/*!40000 ALTER TABLE `passrecovertokens` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `positions` VALUES (3,2,654321,1),(4,2,123456,0),(5,3,123456,0),(6,3,654321,0),(7,4,NULL,0),(8,5,NULL,0),(9,5,NULL,0),(10,5,NULL,0),(11,5,NULL,0),(12,5,NULL,0);
...
INSERT INTO `shifts` VALUES (2,'2018-01-27','05:00:00','06:30:00',0,2),(3,'2018-02-14','04:00:00','05:00:00',0,3),(4,'2018-02-16','01:00:00','02:00:00',1,4),(5,'2018-03-31','12:00:00','14:00:00',5,5);
...
INSERT INTO `studentevent` VALUES (654321,2),(123456,3),(0,2),(654321,3);
...
INSERT INTO `students` VALUES (0,'James','Craig','jamcraig@students.lphs.org','$2y$10$3ngEZpbmj3bGILwUJUp.ouorOgXySkBBWVlMWSQF1S8K/MSYGlH5C',0,'111111','Student'),(111111,'Miloni','Shah','milshah@students.lphs.org','$2y$10$3ngEZpbmj3bGILwUJUp.ouorOgXySkBBWVlMWSQF1S8K/MSYGlH5C',0,'111111','Vice President'),(123456,'Sahil','Patel','sahpatel@students.lphs.org','$2y$10$hwdjJQars/FUxN87la7qSeSss1Wagib0s4Ya9oqQh/zY/4ClgMN7C',6.5,'111111','Admin'),(186573,'Tejas','Hullur','tejhullur@students.lphs.org','$2y$10$3ngEZpbmj3bGILwUJUp.ouorOgXySkBBWVlMWSQF1S8K/MSYGlH5C',25,'Miloni','President'),(194567,'John','Smith','johsmith@students.lphs.org','$2y$10$3ngEZpbmj3bGILwUJUp.ouorOgXySkBBWVlMWSQF1S8K/MSYGlH5C',0,'111111','Student'),(196752,'Jane','Doe','jandoe@students.lphs.org','$2y$10$3ngEZpbmj3bGILwUJUp.ouorOgXySkBBWVlMWSQF1S8K/MSYGlH5C',0,'222222','Student'),(222222,'Nic','Conry','nicconry@students.lphs.org','$2y$10$3ngEZpbmj3bGILwUJUp.ouorOgXySkBBWVlMWSQF1S8K/MSYGlH5C',0,'222222','Vice President'),(654321,'Ben','Wagrez','benwagrez@students.lphs.org','$2y$10$3ngEZpbmj3bGILwUJUp.ouorOgXySkBBWVlMWSQF1S8K/MSYGlH5C',3.5,'222222','Student');
...
INSERT INTO `studentshiftrequests` VALUES (5,123456,5),(2,123456,2);
...
-- Dump completed on 2018-04-29  8:47:04
